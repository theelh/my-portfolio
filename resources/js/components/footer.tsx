...
const Footer = ({ className }: FooterProps) => {
  ...
  const menuItems: MenuItem[] = [
    {
      ...
      links: [
        ...
        { text: t("nav.about", "About"), url: "/welcAbout" },
        { text: t("nav.projects", "Projects"), url: "/welcservices" },
        { text: t("nav.contact", "Contact"), url: "/welccontact" },
      ],
    },
    {
  ...
  return (
    <section className={cn("pt-24 pb-12 bg-black", className)}>
      <footer className="mx-auto w-full max-w-7xl px-6">
        ...
        <div className="mt-20 border-t border-[#2a2a2a] pt-6 text-sm text-gray-400 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p>
            © {currentYear} Marwane Elhosni. {t("footer.rights", "All rights reserved.")}
          </p>
